...
TitleBarLabel.Text = "____/Darkness\\___"
...
Credits_Label.Text = "Made by: Yami and beso \nDiscord: system_Yami and beso \ndis .2gd: "..version
...
SendNotify("Darkness","Gui developed by Yami and besoo - Discord in your clipboard",10)
setclipboard("https://discord.gg/dWjdEBJRjW")
